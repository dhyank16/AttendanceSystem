<html>
    <head>
        ...
        <body>
            ...
            ?>
            <div class="container">
            <h2 class="alert alert-primary">Attendance</h2>
            <div class="row">
                <div class="col">
                <form action="" method="post">
                    ...
                    <br>
                    <input class="btn btn-primary" type="submit" name="show" value="Show Students">
                </form>
                </div>
            </div>
            <div class="row">
                <form action="" method="post">
                    <?php
                        if(isset($_POST['show']))
                        {
                            ...
                            echo "</table>";
                            echo"<input class='btn btn-primary' type='submit' name='mark' value='Mark Attendance'>";
                        } 
                    ?>
                </form>
            </div>
